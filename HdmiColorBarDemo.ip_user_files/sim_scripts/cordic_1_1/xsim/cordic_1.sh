...
#
# Script generated by Vivado on Thu Oct 23 13:58:24 +0800 2025
...
export RDI_DATADIR="C:/vivado/Vivado/2024.2/data"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "cordic_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_19 -L mult_gen_v12_0_22 -L axi_utils_v2_0_10 -L cordic_v6_0_23 -L secureip -L xpm --snapshot cordic_1 xil_defaultlib.cordic_1 -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/vivado/Vivado/2024.2/data/xsim"
  fi
